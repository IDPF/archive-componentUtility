...
IDPF ePub Component Framework
MIT License
Demos: http://components.chaucercloud.com

*/
var epubComponent = epubComponent || {};
epubComponent.AbstractComponent = new Class({
	Implements: [Events, Options],
	initialize: function(componentName, el, options){
		this.name = componentName;
		this.el = el;
		$(this).addClass('epubComponent-component');
		$(this).addClass('epubComponent-'+componentName);
...
epubComponent.util = epubComponent.util || {};
epubComponent.util.Flash = new Class({
...
*/
epubComponent.storage = epubComponent.storage || {};
epubComponent.storage.MemoryStorage = new Class({
	data: null,
	initialize: function(){
		this.data = {};
	},
...
epubComponent.storage.Local = new Class({
	Implements: [Options, Events],
	//DEFAULT OPTIONS
	options: {
		//DEPERECATED
	...
	MAP: {
		memory: new epubComponent.storage.MemoryStorage(),
